    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {viewMode === "list" && isLoading ? (
          // Show card skeleton when company details are being loaded
          <LoadingSkeleton />
        ) : (
          // Show the list of companies when they are loaded
          viewMode === "list" && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 max-w-2xl mx-auto text-lg text-green-600">
        View and manage all the companies' BRSR data in the system
      </p>
