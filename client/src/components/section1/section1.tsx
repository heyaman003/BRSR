...
import BooleanInput from "@/components/question1/boolean1.input";
import TableUI from "@/components/question1/table1";
import TextQuestionUI from "@/components/question1/text1";
